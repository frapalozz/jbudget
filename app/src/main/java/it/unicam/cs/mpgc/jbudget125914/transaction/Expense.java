...
public class Expense extends AbstractTransaction<Double, Money> {
    public Expense(String description, Money amount, LocalDate date, Set<DefaultCategory> categories) {
